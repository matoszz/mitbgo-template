...
type TodoQueryRuleFunc func(context.Context, *generated.TodoQuery) error

// EvalQuery return f(ctx, q).
func (f TodoQueryRuleFunc) EvalQuery(ctx context.Context, q generated.Query) error {
	if q, ok := q.(*generated.TodoQuery); ok {
		return f(ctx, q)
	}
	return Denyf("generated/privacy: unexpected query type %T, expect *generated.TodoQuery", q)
}

// The TodoMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type TodoMutationRuleFunc func(context.Context, *generated.TodoMutation) error

// EvalMutation calls f(ctx, m).
func (f TodoMutationRuleFunc) EvalMutation(ctx context.Context, m generated.Mutation) error {
	if m, ok := m.(*generated.TodoMutation); ok {
		return f(ctx, m)
	}
	return Denyf("generated/privacy: unexpected mutation type %T, expect *generated.TodoMutation", m)
}
